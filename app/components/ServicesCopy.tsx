...
const services: Service[] = [
  ...
  },
  {
    ...
    image: '/images/birthdayorg.png',
    color: 'from-yellow-400 via-pink-500 to-purple-500'
  },
  {
    id: 4,
    title: 'Haldi Ceremony',
    description: 'A beautifully decorated venue designed for the joyous Haldi ceremony, blending tradition with elegance. The space is adorned with floral arrangements, marigold garlands, and vibrant drapery, creating a warm and festive ambiance. With comfortable seating, dedicated areas for rituals, and premium catering services, it ensures a seamless and memorable pre-wedding celebration',
  ...
  },
  {
    ...
    description: 'A lively and beautifully adorned venue, perfect for celebrating the Mehendi ceremony with joy and tradition. Designed with vibrant floral decor, colorful drapes, and traditional seating, the space offers a festive yet intimate ambiance. Guests can enjoy live Mehendi artists, soulful music, and a dedicated area for fun pre-wedding rituals.',
    icon: <FaUsers className="text-4xl text-white" />,
...
const Services = () => {
  ...
  return (
    <section className="section-padding bg-[#f8f5ff] relative overflow-hidden" id="services" ref={containerRef}>
      ...
      {/* Decorative circles */}
      <motion.div 
        className="absolute -top-20 -right-20 w-40 h-40 rounded-full bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 blur-xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3]
        }}
      ...
      <motion.div 
        className="absolute -bottom-20 -left-20 w-60 h-60 rounded-full bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 blur-xl"
        animate={{
          scale: [1, 1.1, 1],
          opacity: [0.2, 0.4, 0.2]
        }}
      ...
      <div className="container-custom">
        ...
        >
          <motion.h2 
            className="heading-secondary text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 mb-2"
          ...
          <motion.h3 
            className="heading-tertiary bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 text-transparent bg-clip-text mb-6"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="p-4 flex items-center">
                  ...
                  <div>
                    <h4 className={`font-semibold ${
                      activeServiceId === service.id ? 'text-white' : 'text-gray-800'
                    }`}>
                      {service.title}
                    </h4>
                  </div>
          ...
          >
            ...
            <div className="p-6">
              <motion.h4 
                className="text-xl font-semibold mb-4 bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 text-transparent bg-clip-text"
              ...
              >
                {[
                  ...
                  >
                    <span className="w-6 h-6 rounded-full bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 flex items-center justify-center mr-2">
              ...
              >
                <Link href="/contact">
                  <motion.button 
                    className="btn-primary bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 text-white"
                    whileHover={{ 
                      scale: 1.05, 
